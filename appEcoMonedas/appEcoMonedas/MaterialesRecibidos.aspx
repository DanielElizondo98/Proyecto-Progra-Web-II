                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="product">
                                            ...
                                            <div class="image" style="border: 1px solid;">
                                                <div class="aClass">
                                                    <asp:Image ID="Image2" runat="server" CssClass="img-fluid image1" ImageUrl='<%# Eval("Imagen", "~/imagenes/material/{0}")%>' Width="90%" /></div>
                                            </div>
                                            <div class="text">
                                                <h3 class="h5"><div class="aClass <%#Item.Color.ClaseCss%> p-1" style="height: 3em;"><%#:Item.Nombre%></div></h3>
