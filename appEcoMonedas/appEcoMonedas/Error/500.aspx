<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="500.aspx.cs" Inherits="appEcoMonedas.Error._500" %>
...
<head runat="server">
    ...
    <title>Error 500 - Error de Servidor Interno</title>
            ...
            <div class="container">
                <div id="error-page" class="col-md-8 mx-auto text-center">
                    <div class="box">
                        ...
                        <h3>Lo sentimos, ha ocurrido un error interno en nuestro servidor.</h3>
                        <h4 class="text-muted">Error 500 - Error de Servidor Interno</h4>
                        <p class="buttons">
