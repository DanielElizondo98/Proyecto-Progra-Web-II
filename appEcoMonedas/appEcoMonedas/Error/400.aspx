<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="400.aspx.cs" Inherits="appEcoMonedas.Error._400" %>
            ...
            <div class="container">
                <div id="error-page" class="col-md-8 mx-auto text-center">
                    <div class="box">
                        ...
                        <h3>No se ha podido realizar la comunicación con el servidor.</h3>
                        <h4 class="text-muted">Error 400 - Solicitud incorrecta</h4>
                        <p class="buttons">
