<%@ Page Title="" Language="C#" MasterPageFile="~/PrincipalAdministrador.Master" AutoEventWireup="true" CodeBehind="PerfilAdministrador.aspx.cs" Inherits="appEcoMonedas.PerfilAdministrador" %>
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills flex-column text-sm">
                                <li class="nav-item"><a href="PerfilAdministrador.aspx" class="nav-link active"><i class="fa fa-id-card-o"></i>  Editar Perfil</a></li>
                                <li class="nav-item">
