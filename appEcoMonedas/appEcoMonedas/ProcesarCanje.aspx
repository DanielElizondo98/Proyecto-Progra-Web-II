                        ...
                        <div class="box-footer d-flex justify-content-between align-items-center w-100" style="margin-top: 0px !important;">
                            <div class="row">
                                ...
                                <asp:HiddenField ID="hiddenIDCentro" runat="server" />
                                    <asp:LinkButton ID="btnProcesar" ValidationGroup="validaProcesado" OnClick="btnProcesar_Click" CssClass="btn btn-primary text-white" runat="server">Procesar Canje  <i class="fa fa-recycle gly-rotate-45"></i></asp:LinkButton>
